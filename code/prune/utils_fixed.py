...
def get_args():
    ...
    # 修改为AutoDL服务器路径
    parser.add_argument('--data_dir', default='/root/autodl-tmp/nku/DEALRec-main/data/', type=str)
    parser.add_argument('--output_dir', default='/root/autodl-tmp/nku/DEALRec-main/models/', type=str)
    ...
    # LLM参数 - 修改为AutoDL服务器路径
    parser.add_argument("--base_model", type=str, 
                       default="yahma/llama-7b-hf", 
                       help="HuggingFace model name or local path")
    parser.add_argument("--train_data_path", type=str, 
                       default="/root/autodl-tmp/nku/DEALRec-main/data/games/train_49156.json", 
                       help="your path of the training data")
    parser.add_argument("--resume_from_checkpoint", type=str, 
                       default="/root/autodl-tmp/nku/DEALRec-main/checkpoints/alpaca-lora/", 
                       help="path of the alpaca lora adapter")
